...
minUnusedSpace = 30000000
totalUsedSpace = allDirectories['/'].size
spaceNeeded = minUnusedSpace - (totalDiskSpace - totalUsedSpace)

deleteSize = 30000000
for dirPath in allDirectories:
    if allDirectories[dirPath].size >= spaceNeeded and allDirectories[dirPath].size < deleteSize:
        deleteSize = allDirectories[dirPath].size
